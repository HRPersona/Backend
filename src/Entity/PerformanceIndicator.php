...
/**
 * @ORM\Entity()
 * @ORM\Table(name="ap_indicators", indexes={
 *     @ORM\Index(name="indicator_search_idx", columns={"code", "name"}),
 *     @ORM\Index(name="indicator_search_idx_code", columns={"code"}),
 *     @ORM\Index(name="indicator_search_idx_name", columns={"name"})
 * })
 *
 * @ApiResource(
 *     attributes={
