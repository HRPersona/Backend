...
/**
 * @ORM\Entity()
 * @ORM\Table(name="at_holidays", indexes={@ORM\Index(name="holiday_search_idx", columns={"name"})})
 *
 * @ApiResource(
 *     attributes={
 ...
 */
class Holiday implements HolidayInterface, ActionLoggerAwareInterface
{
     ...
     */
    public function setHolidayDate(\DateTime $holidayDate)
    {
