 ...
 *     @ORM\Index(name="employee_skill_search_idx", columns={"employee_id", "skill_id"}),
 *     @ORM\Index(name="employee_skill_search_employee", columns={"employee_id"}),
 *     @ORM\Index(name="employee_skill_search_skill", columns={"skill_id"})
 * })
 *
 * @ApiResource(
 *     attributes={
