...
/**
 * @ORM\Entity()
 * @ORM\Table(name="s_provinces", indexes={
 *     @ORM\Index(name="province_search_idx", columns={"code", "name"}),
 *     @ORM\Index(name="province_search_idx_code", columns={"code"}),
 *     @ORM\Index(name="province_search_idx_name", columns={"name"})
 * })
 *
 * @ApiResource(
 *     attributes={
